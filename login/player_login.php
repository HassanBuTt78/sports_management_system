 ...
 * player_login.php
 * ------------------------------------------------------------
 * Player login. See admin_login.php for the full flow comments.
 * ============================================================
 */
...
<div class="auth-role-switch">
  ...
  <a href="player_login.php" class="active"><i class="fa-solid fa-person-running me-1"></i> Player</a>
</div>

<span class="auth-role-tag"><i class="fa-solid fa-person-running me-1"></i>Player</span>
<h2 class="auth-heading">Player Sign In</h2>
<p class="auth-subheading">Check your schedule, your team, and register for events.</p>

<?php if ($errorMessage): ?>
  <div class="alert alert-danger auth-alert" role="alert"><?php echo safeOut($errorMessage); ?></div>
<?php endif; ?>

<form method="POST" action="player_login.php" class="needs-validation" novalidate>
  ...
  <div class="auth-options">
    ...
    <a href="forgot_password.php?role=player">Forgot Password?</a>
  </div>
